...
const QurbaniTips = () => {
  return (
    <div className="site-wrapper px-4">
      <div className="text-center mb-12 ">
        <p className="text-2xl font-medium text-primary mb-2">Guidance</p>
        <h2 className="font-display text-3xl md:text-4xl font-semibold text-green-500">
          Qurbani <span className="text-orange-500 text-5xl">Tips</span>
        </h2>
      </div>
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-green-100 p-7 rounded-2xl  border shadow-card">
          <div className="h-12 w-12 rounded-xl bg-primary/10 grid place-items-center text-primary mb-4">
            <svg
          ...
          <h3 className="font-display text-xl font-semibold mb-2">Check Health</h3>
        ...
        <div className="bg-green-100 p-7 rounded-2xl border border-border shadow-card">
          <div className="h-12 w-12 rounded-xl bg-primary/10 grid place-items-center text-primary mb-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="lucide lucide-heart-handshake h-6 w-6"
              aria-hidden="true"
            >
          ...
          <h3 className="font-display text-xl font-semibold mb-2">Verify Age</h3>
          <p className="text-sm text-muted-foreground leading-relaxed text-gray-600">
        ...
        <div className="bg-green-100 p-7 rounded-2xl border border-border shadow-card">
          <div className="h-12 w-12 rounded-xl bg-primary/10 grid place-items-center text-primary mb-4">
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="lucide lucide-truck h-6 w-6"
              aria-hidden="true"
            >
          ...
          <h3 className="font-display text-xl font-semibold mb-2">Plan Delivery</h3>
          <p className="text-sm text-muted-foreground leading-relaxed text-gray-600">
